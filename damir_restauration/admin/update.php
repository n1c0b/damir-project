...
<div class="container">
    <div class="row">
        <div class="col-md-6">  
        <form class="form bgr" action="<?php echo 'update.php?id=' . $id; ?> " method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                     <img class="card-img-top" src="<?php echo '../images/' . $image  ; ?>" alt="...">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-warning wr" role="button"><i class="fas fa-shopping-cart"></i>Commander</a>
                        </div> 
                </div>
